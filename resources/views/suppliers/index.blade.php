...
<div class="container">
    ...
    <div class="card">
        <div class="card-header bg-navy">
            <h3 class="card-title">List Bandar</h3>
        </div>
        <!-- /.card-header -->
            ...
            <form method="post" id="itemForm" name="itemForm">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm mr-2" name="address" id="address" required>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">No HP : <i id="supplier"></i></li>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#createNewItem').click(function () {
                ...
                $('#modal-title').html("Tambah Bandar");
                $('#modal-md').modal('show');
            });

            // $('body').on('click', '#showProduct', function() {
            //     var product_id = $(this).data('id');
            //     $.get("{{ route('suppliers.index') }}" + '/' + product_id, function(data) {
            ...
            //         $('#supplier').html(data.address_number);
            //     })
            // });
            ...
            $(document).on('click','button#deleteAllBtn', function(){
                ...
                var url = '{{ route("suppliers.deleteSelected") }}';
